...
class RoyalleSpider(scrapy.Spider):
    ...
    def parse(self,response):
        url_list = response.xpath('.//*[@class="card__media"]/a/@href').getall()
    ...
    def detail_page(self,response):
        ...
        price = response.xpath('.//*[@class="property-price-wrapper"]/span/span/text()').getall()
        ...
        feature_list = response.xpath('.//div[@class="details-row"][1]/ul[@class="property-features-list"]/li/span[1]/text()').getall()

        for key in feature_list:
            key = key.replace(':','')
            features[f'{key}'] = response.xpath(f'.//*[contains(text(),"{key}")]/following-sibling::span/text()').get()

        item['FEATURES'] = features

        lot_area = response.xpath('.//*[contains(text(),"Lot Size:")]/following-sibling::span/text()').re_first(r'([\d.]+)')

        item['LOT_AREA'] = self.StrToNum(lot_area)

        year_built = response.xpath('.//*[contains(text(),"Built in:")]/following-sibling::span/text()').get()
        item['YEAR_BUILT'] = self.StrToNum(year_built)

        assessment = {}

        lot_assessment = response.xpath('.//*[contains(text(),"Lot Assessment:")]/following-sibling::span/text()').get()
        building_assessment = response.xpath('.//*[contains(text(),"Building Assessment:")]/following-sibling::span/text()').get()
        total_assesment = response.xpath('.//*[contains(text(),"Total Assessment:")]/following-sibling::span/text()').get()
        ...
        revenue = {}
        residental = response.xpath('.//*[contains(text(),"Revenue")]/following-sibling::*//*[contains(text(),"Residential")]/following-sibling::span/text()').get()
        commercial = response.xpath('.//*[contains(text(),"Revenue")]/following-sibling::*//*[contains(text(),"Commercial")]/following-sibling::span/text()').get()
        parking = response.xpath('.//*[contains(text(),"Revenue")]/following-sibling::*//*[contains(text(),"Parking")]/following-sibling::span/text()').get()
        ...
        revenue['TOTAL'] = sum([revenue['RESIDENTIAL'], revenue['COMMERCIAL'], revenue['PARKING']])

        item['REVENUE'] = revenue

        expenses = {}

        insurance = response.xpath('.//*[contains(text(),"Expenses:")]/following-sibling::*//*[contains(text(),"Insurance")]/following-sibling::span/text()').get()
        snow_removal = response.xpath('.//*[contains(text(),"Expenses:")]/following-sibling::*//*[contains(text(),"Snow Removal")]/following-sibling::span/text()').get()
        electric = response.xpath('.//*[contains(text(),"Expenses:")]/following-sibling::*//*[contains(text(),"Electric")]/following-sibling::span/text()').get()
        gas = response.xpath('.//*[contains(text(),"Expenses:")]/following-sibling::*//*[contains(text(),"Gas")]/following-sibling::span/text()').get()
        energy = response.xpath('.//*[contains(text(),"Expenses:")]/following-sibling::*//*[contains(text(),"Energy")]/following-sibling::span/text()').get()
        ...
        municiple_tax = response.xpath('.//*[contains(text(),"Municipal Tax:")]/following-sibling::span/text()').get()
        school_tax = response.xpath('.//*[contains(text(),"School Tax:")]/following-sibling::span/text()').get()
