...
class Kijiji(scrapy.Spider):
	...
	def detail_page(self,response):
		...
		price = response.xpath('.//*[contains(@class,"priceWrapper")]/*/@content').get()
		if price:
		...
		type_ = response.xpath('(.//*[@class="noLabelValue-3861810455"]/text())[1]').get()
		item['TYPE'] = type_

		bedroom = response.xpath('(.//*[@class="noLabelValue-3861810455"]/text())[2]').re_first(r'([\d]+)')
		if bedroom:
		...
		bathroom = response.xpath('(.//*[@class="noLabelValue-3861810455"]/text())[3]').re_first(r'([\d]+)')
		try:
		...
		wifi = response.xpath('.//*[contains(text(),"Wi-Fi and More")]/following-sibling::*/text()').get()
		item['TELECOM'] = wifi

		parking = response.xpath('.//*[contains(text(),"Parking Included")]/following-sibling::*/text()').get()
		if parking:
		...
		agreement_type = response.xpath('.//*[contains(text(),"Agreement Type")]/following-sibling::*/text()').get()
		item['AGREEMENT_TYPE'] = agreement_type

		moving_date = response.xpath('.//*[contains(text(),"Move-In Date")]/following-sibling::*/*/text()').get()
		item['MOVING_DATE'] = moving_date

		pet_friendly = response.xpath('.//*[contains(text(),"Pet Friendly")]/following-sibling::*/text()').get()
		if pet_friendly:
		...
		size_sqft = response.xpath('.//*[contains(text(),"Size (sqft)")]/following-sibling::*/text()').get()
		if size_sqft:
		...
		furnished = response.xpath('.//*[contains(text(),"Furnished")]/following-sibling::*/text()').get()
		if furnished:
			if 'No' in furnished:
				furnished = False
			else:
		...
		air_condition = response.xpath('.//*[contains(text(),"Air Conditioning")]/following-sibling::*//text()').get()
		if air_condition:
		...
		personal_outdoor_space = response.xpath('.//*[contains(text(),"Personal Outdoor Space")]/following-sibling::*//text()').get()
		item['PERSONAL_OUTDOOR_SPACE'] = personal_outdoor_space

		smoking_permitted = response.xpath('.//*[contains(text(),"Smoking Permitted")]/following-sibling::*//text()').get()
